...
#define GPIOB_BASEADDR			    (GPIOA_BASEADDR + 0x400)
#define GPIOC_BASEADDR				(GPIOB_BASEADDR + 0x400)
#define GPIOD_BASEADDR				(GPIOC_BASEADDR + 0x400)
#define GPIOE_BASEADDR				(GPIOD_BASEADDR + 0x400)
#define GPIOF_BASEADDR				(GPIOE_BASEADDR + 0x400)
#define GPIOG_BASEADDR				(GPIOF_BASEADDR + 0x400)
#define GPIOH_BASEADDR				(GPIOG_BASEADDR + 0x400)
#define RCC_BASEADDR				(AHB1_BASEADDR + 0x3800)

/* Base addresses of APB1 Peripherals */

#define I2C1_BASEADDR				(APB1_BASEADDR + 0x5400)
#define I2C2_BASEADDR				(I2C1_BASEADDR + 0x400)
#define I2C3_BASEADDR				(I2C2_BASEADDR + 0x400)
#define SPI2_BASEADDR				(APB1_BASEADDR + 0x3800)
#define SPI3_BASEADDR				(SPI2_BASEADDR + 0x400)
#define USART2_BASEADDR				(APB1_BASEADDR + 0x4400)
#define USART3_BASEADDR				(USART2_BASEADDR + 0x400)
#define UART4_BASEADDR				(USART3_BASEADDR + 0x400)
#define UART5_BASEADDR				(UART4_BASEADDR + 0x400)
...
#define USART6_BASEADDR				(USART1_BASEADDR + 0x400)
#define ADC_BASEADDR				(USART6_BASEADDR + 0x400)
